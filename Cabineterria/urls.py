...
from .views import Home, CabinetView, BuildCabinet, Login, Signup, Logout, Profile, Answer, BuildQuestion

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Home.as_view(), name='home'),
    path('build/', BuildCabinet.as_view(), name="build_cabinet"),
    path('attach_question/', BuildQuestion.as_view(), name="build_question"),
